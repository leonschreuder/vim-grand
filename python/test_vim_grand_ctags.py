...
class TestGrandCtags (unittest.TestCase):
    ...
    def testVimGrandCtagsFile(self):
        # TODO could not get the simple mocking of 'from filename import class' to use the below mock version
        # and I didn't want to create an entrire file for it. Without mocking the class will just generate the
        # ctags file. Which I don't want to wait for (or cancel) every test run.
        None
